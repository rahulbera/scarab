...
class IMemorySystem : public TopLevel<IMemorySystem> {
  RAMULATOR_REGISTER_INTERFACE(IMemorySystem, "MemorySystem",
                               "Memory system interface (e.g., communicates "
                               "between processor and memory controller).")
 ...
 public:
   ...
   * @return   false    Request is rejected by the memory system, maybe the
   * memory controller is full?
   */
