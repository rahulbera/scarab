...
// TODO: Better Logging interface. Put logging methods into Implementation base
// class?
namespace Ramulator {
...
class Logging {
 ...
 public:
   ...
   * @return Logger_t
   */
  static Logger_t create_logger(std::string name,
                                std::string pattern = default_logger_pattern);
