...
int
  // HPCC_RandomAccess(HPCC_Params *params, int doIO, double *GUPs, int
  // *failure) {
  main(int argc, char* argv[]) {
  int       fd_instructions, fd_cycles, fd_load_ptws, fd_store_ptws;
  long long instructions, cycles, load_ptws, store_ptws;
